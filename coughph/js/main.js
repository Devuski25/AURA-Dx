document.addEventListener("DOMContentLoaded", function () {
    ...
    if (proceedBtn) {
      proceedBtn.addEventListener("click", function () {
        ...
        if (screeningPanel) {
          ...
          var uploadBtn = screeningPanel.querySelector("[data-upload-btn]");
          if (uploadBtn) uploadBtn.classList.remove("is-disabled");
  ...
  // --- Password visibility toggle (login.html, register.html) ---
  document.querySelectorAll("[data-pw-toggle]").forEach(function (toggle) {
    var pwInput = toggle.parentElement.querySelector("input");
    var pwEye = toggle.querySelector(".pw-eye");
    var pwEyeOff = toggle.querySelector(".pw-eye-off");
    if (!pwInput) return;
    toggle.addEventListener("click", function () {
      var isHidden = pwInput.type === "password";
      pwInput.type = isHidden ? "text" : "password";
      if (pwEye) pwEye.style.display = isHidden ? "none" : "";
      if (pwEyeOff) pwEyeOff.style.display = isHidden ? "" : "none";
    });
  });
