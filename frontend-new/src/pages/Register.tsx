...
export function Register() {
  ...
  return (
    <motion.div
      ...
      initial="initial"
      animate="animate"
      className="min-h-screen flex items-center justify-center bg-cough-surface px-4 py-12">
      <Card className="w-full max-w-md">
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-cough-muted">At least 8 characters with uppercase, lowercase, number, and a special character</p>
        ...
        <CardFooter className="flex justify-center">
          <p className="text-sm text-cough-muted">
